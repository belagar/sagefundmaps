...
# Makes changes to the Website Homepage Map to try out without pushing to the actual website.

# Started with a copy of the final homepage map below and then make changes.

SAGE_map_homepage_test <- leaflet(SAGE_pts, options = leafletOptions(minZoom = 2, maxZoom = 4)) %>%
...
addCircleMarkers(data=Debt, ~longitude, ~latitude, color = NA, fillColor= "#48a999", fillOpacity = 0.84, group = "Debt & Post-Covid Recovery", radius = 7,
                                      popup = ~describe) %>%
  
addCircleMarkers(data=R8, ~longitude, ~latitude, color = NA, fillColor= "#336600", fillOpacity = 0.84, group = "Climate Justice and Corporate Accountability", radius = 7,
                                      popup = ~describe) %>%
  
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
                                      popup = ~describe) %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
   ...
   addControl("SAGE Fund Projects", position = "bottomright") %>%
    ...
    overlayGroups = c("Investment Mapping Tools", "Remedy and OGMs", "Community Driven Strategies", "Enforcement Strategies", "Remedy for Mining Disasters", "Gender Justice", "Worker Empowerment Strategies", "Debt & Post-Covid Recovery", "Climate Justice and Corporate Accountability", "Cross-Movement Building"),
    options = layersControlOptions(collapsed = FALSE)) %>% 
  
  hideGroup("Remedy and OGMs") %>%  hideGroup("Community Driven Strategies") %>%  hideGroup("Enforcement Strategies") %>% hideGroup("Remedy for Mining Disasters") %>% hideGroup("Gender Justice") %>% hideGroup("Worker Empowerment Strategies") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
  ...
  hideGroup("Investment Mapping Tools") %>%  hideGroup("Community Driven Strategies") %>%  hideGroup("Enforcement Strategies") %>% hideGroup("Remedy for Mining Disasters") %>% hideGroup("Gender Justice") %>% hideGroup("Worker Empowerment Strategies") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
  ...
  hideGroup("Investment Mapping Tools") %>%  hideGroup("Remedy and OGMs") %>%  hideGroup("Enforcement Strategies") %>% hideGroup("Remedy for Mining Disasters") %>% hideGroup("Gender Justice") %>% hideGroup("Worker Empowerment Strategies") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
  ...
  hideGroup("Investment Mapping Tools") %>%  hideGroup("Community Driven Strategies") %>%  hideGroup("Remedy and OGMs") %>% hideGroup("Remedy for Mining Disasters") %>% hideGroup("Gender Justice") %>% hideGroup("Worker Empowerment Strategies") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
  ...
  hideGroup("Investment Mapping Tools") %>%  hideGroup("Community Driven Strategies") %>%  hideGroup("Enforcement Strategies") %>% hideGroup("Remedy and OGMs") %>% hideGroup("Gender Justice") %>% hideGroup("Worker Empowerment Strategies") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
  ...
  hideGroup("Investment Mapping Tools") %>%  hideGroup("Community Driven Strategies") %>%  hideGroup("Enforcement Strategies") %>% hideGroup("Remedy for Mining Disasters") %>% hideGroup("Remedy and OGMs") %>% hideGroup("Worker Empowerment Strategies") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
...
addCircleMarkers(data=CMB, ~longitude, ~latitude, color = NA, fillColor= "#996633", fillOpacity = 0.84, group = "Cross-Movement Building", radius = 7,
  ...
  hideGroup("Investment Mapping Tools") %>%  hideGroup("Community Driven Strategies") %>%  hideGroup("Enforcement Strategies") %>% hideGroup("Remedy for Mining Disasters") %>% hideGroup("Gender Justice") %>% hideGroup("Remedy and OGMs") %>% hideGroup("Debt & Post-Covid Recovery") %>% hideGroup("Climate Justice and Corporate Accountability") %>% hideGroup("Cross-Movement Building") %>%
